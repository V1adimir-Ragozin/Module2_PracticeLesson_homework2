...
my_nonsense = ['Варкалось, хливкие шорьки пырялись по наве', 'И хрюкотали зелюки как мюмзики в мове',
...
my_favorite_animals = ['cat', 'wolf', 'ostrich']
if 'lion' in my_favorite_animals:
    print('Wow!')

MyFavoriteAnimals = ['cat', 'wolf', 'ostrich']
